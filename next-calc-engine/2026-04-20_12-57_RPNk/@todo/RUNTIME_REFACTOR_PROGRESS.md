...
| A2 — Pré-extração lib | 6 | 0 | 0% | 🔴 Não iniciada | Fase 2 Runtime |
...
**Critério de saída:** nenhum arquivo de `lib/runtime/` é importado para fins de UI; builder/test runner usam mesma API canônica; contratos de API atualizados; comportamento de input inválido alinhado entre API/builder/calculator.
